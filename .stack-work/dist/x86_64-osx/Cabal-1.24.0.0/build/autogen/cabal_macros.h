...
/* package sghh-zip-0.1.0.0 */
#define VERSION_sghh_zip "0.1.0.0"
#define MIN_VERSION_sghh_zip(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package zip-0.1.3 */
#define VERSION_zip "0.1.3"
#define MIN_VERSION_zip(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "sghh-zip-0.1.0.0"

#define CURRENT_PACKAGE_KEY "sghh-zip-0.1.0.0"
